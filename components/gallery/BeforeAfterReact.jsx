...
class BeforeAfter extends Component {
  ...
  render() {
    ...
    return (
      <div ref={this.wrapRef} className={`before-after-wrap ${containerClass ? containerClass : ""}`}>
        <img onLoad={this.setToLoaded} src={firstImgSrc} alt="left" />
        <div className={`resize ${this.props.vertical ? "vertical" : "horizontal"}`} ref={this.resize}>
          <img
